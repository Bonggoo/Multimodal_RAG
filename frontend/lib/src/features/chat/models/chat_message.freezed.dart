...
class _$ChatMessageImpl implements _ChatMessage {
  ...
  @override
  String toString() {
    return 'ChatMessage(id: $id, role: $role, content: $content, imageUrl: $imageUrl, citations: $citations, traceId: $traceId, timestamp: $timestamp)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, role, content, imageUrl,
      const DeepCollectionEquality().hash(_citations), traceId, timestamp);
